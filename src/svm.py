...
parser = argparse.ArgumentParser(description="Type parameters combines")
parser.add_argument('integers', metavar='N', type=int, nargs='+',
                    help='combines for parameters')
...
model = SVC(probability=True, C=np.exp2(range(-5, 15))[args.integers[0]], gamma=np.exp2(range(-16, 9))[args.integers[1]])
